...
HTML_HeadStart();
     ...
     HTML_Title("Global Rank - Rixrank");
...
HTML_DivStart("big_box");
     ...
     HTML_DivStart("box_main");
          HTML_DivStart("box_rank_female");
               ...
               $FileXML = XML_Load("../data/ranking/global/female.xml");
               foreach ($FileXML->rank as $rank)
               {
                    HTML_DivStart("box_top1");
                         ...
                         HTML_DivStart("hed_text");
                              HTML_Text($Counter);
                              HTML_AddImageSize("../flag/".$rank->country.".ico",30,20);
                         HTML_DivEnd();
     ...
     HTML_DivStart("box_main");
          ...
          $FileXML = XML_Load("../data/ranking/global/male.xml");
          foreach ($FileXML->rank as $rank)
          {
               HTML_DivStart("box_top1");
