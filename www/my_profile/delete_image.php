       ...
       if(SecurityStringNumber($_GET['id']))
       {
        $ID = $_GET['id'];
             ...
             if($ID>1 && $ID<=60 )
             {
              ...
              SQL_Connect();
              if($_SESSION['USRS'] == 0) $DataArray2 = SQL_ResultDeleteImage($_SESSION['USR'],$Data2,$Data) ;
              if($_SESSION['USRS'] == 1) $DataArray2 = SQL_ResultDeleteImageF($_SESSION['USR'],$Data2,$Data) ;
            ...
            unlink("../upload_images".$VAR."/".File_NameFolder($Data)."/".$Data.".jpg");
            
            
            $HandleFile = File_Open("../data/delimg".$VAR.".lock");
            if( File_WriteLock($HandleFile) )
            {
               DeletedImage_Add("../data/delimg".$VAR.".xml",$Data);
            }
