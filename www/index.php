...
if($_SERVER['REMOTE_ADDR'] != '89.74.179.178'){
$fn = 'bin/stats/main.txt';
file_put_contents($fn, '['.date('d-m-Y H:i:s').']<'.$_SERVER['REMOTE_ADDR'].'>{'.$_SERVER['HTTP_REFERER'].'}');
$fn = "bin/stats/main".date('d_m_y').".txt";
if(!file_exists($fn)) fopen($fn,'w');
$counter = (file_exists($fn) ? (int)file_get_contents($fn) : 0) + 1;
file_put_contents($fn, $counter);

$fp = fopen("bin/stats/main_log.txt", "a");
fputs($fp, '['.date('d-m-Y H:i:s').']<'.$_SERVER['REMOTE_ADDR'].'>{'.$_SERVER['HTTP_REFERER'].'}');
fclose($fp);
} 
...
HTML_HeadStart();
    ...
    echo "<meta name='description' content='Share your the best pictures and become a winner.
	...
	echo "<meta name='generator' content='Rixrank' />";
	echo "<meta name='p:domain_verify' content='53fe8cadd88867a57ca56008fc9a600f'/>";
	echo "<meta name='keywords' content='model,models,girl,girls,women,beautiful,compare images,friends,funny,good time
	men,ranking images, ranking country, ranking, country, world,countries,beautiful girls,beautiful girl' />";
	echo "<meta http-equiv='content-language' content='en-us' />";
	echo "<meta name='revised' content='Rixrank, ".date('d/m/y')."' />";
	echo "<meta name='author' content='Lucas & Matthew' /> ";
HTML_Title("Rixrank welcomes you!");
HTML_HeadEnd();

//if (isset($_GET['id'])) if($_GET['id'] == 1) echo "wrong nick or password" ;
?>
<style>
...
div.margtop:hover{background-color: rgba(255,255,255,.5);}
...
div.register_box:hover{background-color: rgba(255,255,255,.5);}
...
div.text:hover{background-color: rgba(45,45,45,.5);}
...
div.register_display{
    display:inline;
    margin-right: 0px;
}

div.register_display2{
    color: rgb(230,115,0);
    border:2px solid rgba(230,115,0,.0);
    width: 170px;
    height: 25px;
    font-family: sans-serif;
    font-size: 18px;
...
input:focus{ background: rgb(45,45,45); color:rgb(230,115,0); border-bottom: 2px solid rgb(230,115,0);}
input[type="text"]:hover{ background: rgb(45,45,45); color:rgb(230,115,0); border-bottom: 2px solid rgb(230,115,0); }
...
input[type="password"]
{
    ...
    font-family: sans-serif;
    font-size: 15px;
    border:0px solid rgba(230,115,0,.0);
    border-bottom: 2px solid rgb(45,45,45);
}

input[type="password"]:focus {  background: rgb(45,45,45); color:rgb(230,115,0); border-bottom: 2px solid rgb(230,115,0); }
input[type="password"]:hover {  background: rgb(45,45,45); color:rgb(230,115,0); border-bottom: 2px solid rgb(230,115,0); }

button[name="login"]{
    background-color: rgba(230,115,0,.0);
    height: 30px;
    width: 100px;
    font-family: sans-serif;
    font-size: 18px;
...
button[name="login"]:hover{ color:rgb(230,115,0); background-color: rgb(45,45,45);}

button[name="forgotten"]{
    background-color: rgba(230,115,0,.0);
    height: 20px;
    width: 190px;
    font-family: sans-serif;
...
button[name="forgotten"]:hover{color:rgb(230,115,0);}
...
input[name="mail23"]:focus{
    border-top: 0px solid rgb(45,45,45);
    border-right: 0px solid rgb(45,45,45);
    border-left: 0px solid rgb(45,45,45);
}

button[id="button_forgot_pass"]{
    background-color: rgba(230,115,0,.0);
    height: 30px;
    width: 100px;
    font-family: sans-serif;
...
button[id="button_forgot_pass"]:hover{background-color: rgb(230,115,0); color:rgb(45,45,45);}
...
div.guest{
    font-size: 40px;
    border-bottom: 2px solid rgb(230,115,0);
    padding-left: 10px;
    text-shadow: 5px 5px 8px rgb(230,115,0);
}
</style>
<script>
/*!
...
$("#signin").click(function() {
  ...
  //alert(nick + "  " + pass + " Sex: " + sex + " Mail: " + mail + " Statute: " + statute);
...
<div class="text">
    <div class="text_head">
        <strong>Rixrank welcomes you!</strong>
    </div>
    <div class="text_small_head">
         <h4>Add a photo and join the fun.</h4>
    </div>
    ...
    <div class="text_body">
         ...
         <br><br>
         <div class="guest">
            <a href="compare/" style="text-decoration: none"><strong>Test Rixrank! Join as a guest here!</strong></a>
         </div>
    </div>
